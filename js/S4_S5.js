...
monogatari.script ({
  ...
  'S4_yes':[
    ...
    'me 나 지금 대표 앞에서 접수번호 어쩌고라고 한거야? 맙소사. ',
    'me 쪽팔릴 것이라면 직원이었으면 했으나, 대표라니.',

    '넋이 나간 표정을 하고 있는 나를 뒤로하고, 남자는 직원에게 말했다.',

    'kang 확인도 안 하고, 카드를 발송하시면 어떡합니까? ',
    'kang 문제없이 면접 치르게 하세요.',
    ...
    'me 회사생활을 한다고 한들, 내가 저 대표를 살면서 몇 번이나 마주치겠어. ',
    'me 좋게 생각하자. 좋은 게 좋은 것 아니겠어?',
...
// ----------------- 씬5 주석 -----------------
  ...
  'S5_in' :[
    ...
    'lee 파일 다운로드 해서 출력하고, 동료들 이름이랑 직급 먼저 외우고 있어. ',
    'play voice S005_004(Lee)',
    'lee 그리고 여기 회사야. 직급 외우고 호칭 제대로 불러. ',
    ...
    'me 대표씩이나 되는 사람이, 사원들이 있는 곳에 내려오기도 하나? ',
  ...
  'S5_out' :[
    ...
    'me 아무리 바빠도 그렇지, 이 한여름님이 커피를 손수 가져다줬는데! ',
    'me 감히 건성으로!!  골탕 좀 먹어봐라.',
    ...
    'male_employee2 한여름씨. 호칭 정정 안합니까? 여기가 놀이턴 줄 아세요?! ',

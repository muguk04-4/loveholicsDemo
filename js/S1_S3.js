...
// ----------------- 씬2 주석 -----------------
	...
	'S2_yes':[
		...
		'lee 왜긴 왜야? 너 오늘 면접보는 날이잖아! 아직도 집이면 어떡해?',
		...
		'lee 택시부터 불러! 30분 전에 도착해야 한다고 일찍 일어나야한다고 내가 그렇~게 얘기했는데, 또 제대로 안 들었지?',
...
// ----------------- 씬3 주석 -----------------
	'S3': [
		...
		'me 크흠. 아아. 접수번호 98번. 한여름입니다. 아, 목소리 가라앉았네.',
		
		' 목소리가 조금 가라앉은 것 같다. 일어난 지 얼마 되지 않았다는 게 티가 나진 않겠지? ',
		'나는 다시 한번 목소리를 가다듬어보았다.',

		'me 크흠! 접수번호 98번. 한여름입니다. ',
		
		'stop music bgm_energy with fade 3',
	...
	'S3_after' :[
		...
		'me 아씨.. 왜 안되는거야. 어떡하지? 30분은 벌써 지난 것 같은데..',
		...
		'show character kang normal_R fadeIn with duration 2s',
		'kang 저희측 실수인 것 같네요. 이쪽으로 잠시 나오세요. 열어드리겠습니다.',
		'me 네?',
